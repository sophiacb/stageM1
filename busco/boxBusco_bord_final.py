...
plt.text(1.6, 55, 'high', fontsize = 11,  bbox={'facecolor':'#43A2CA', 'alpha':0.5, 'pad':7})
plt.text(3.5, 55, 'medium', fontsize = 11, bbox={'facecolor':'#43A2CA', 'alpha':0.5, 'pad':7})
plt.text(16, 55, 'low',  fontsize = 11, bbox={'facecolor':'#43A2CA', 'alpha':0.5, 'pad':7})

plt.text(7.3, 55, 'high', fontsize = 11, bbox={'facecolor':'#DD1C77', 'alpha':0.5, 'pad':7})
plt.text(19, 55, 'high', fontsize = 11, bbox={'facecolor':'#DD1C77', 'alpha':0.5, 'pad':7})

plt.annotate('', xy=(6.8,55), xytext=(5.9,55), arrowprops=dict(arrowstyle="->", facecolor='black'))
plt.annotate('', xy=(18.4,55), xytext=(17.5,55), arrowprops=dict(arrowstyle="->", facecolor='black'))
...
plt.savefig('boxBusco_bord_txtparam.png', dpi=200)
plt.show()
