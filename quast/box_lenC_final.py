...
plt.text(1.5, 0.90, 'high', fontsize = 12,  bbox={'facecolor':'#43A2CA', 'alpha':0.5, 'pad':7})
plt.text(4.5, 0.90, 'medium', fontsize = 12, bbox={'facecolor':'#43A2CA', 'alpha':0.5, 'pad':7})
plt.text(15.5, 0.90, 'low',  fontsize = 12, bbox={'facecolor':'#43A2CA', 'alpha':0.5, 'pad':7})

plt.text(8.5, 0.90, 'high', fontsize = 11, bbox={'facecolor':'#DD1C77', 'alpha':0.5, 'pad':7})
plt.text(19.5, 0.90, 'high', fontsize = 11, bbox={'facecolor':'#DD1C77', 'alpha':0.5, 'pad':7})

plt.annotate('', xy=(8, 0.90), xytext=(7.2, 0.90), arrowprops=dict(arrowstyle="->", facecolor='black'))
plt.annotate('', xy=(18.3, 0.90), xytext=(17.5, 0.90), arrowprops=dict(arrowstyle="->", facecolor='black'))
...
plt.savefig('boxplot_quast_lenC_txtparam.png', dpi=200)
plt.show()
